...
public class Roles {
    ...
    public static Result list() {  
        try {
            List<Role> objects = Role.getList();
            JsonNode jsonObjects = Role.jsonListSerialization(objects);
    ...
    public static Result get(Long id) {  
        try {
            Role object = Role.findByPropertie("id", id);
    ...
    public static Result delete(Long id) {
        ...
        // Find the object
        try {
            object = Role.findByPropertie("id", id);
        } catch (Exception e) {
